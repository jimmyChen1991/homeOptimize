...
public class ActiveGoodAdapter extends BaseAdapter{
	...
	public ActiveGoodAdapter(Context context) {
		super();
	...
	public void setAddListener(ItemAddListener l){
		mItemAddListener = l;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = mLayoutInflater.inflate(R.layout.activegood_item, null);
